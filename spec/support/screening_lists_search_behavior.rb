...
shared_context "ScreeningList::Sdn data" do
  before(:all) do
    ...
    @all_possible_full_results ||= {}
    @all_possible_full_results[ScreeningList::Sdn] = JSON.parse(
      open("#{File.dirname(__FILE__)}/screening_lists/sdn/expected_results.json",).read,)
  end
end
...
shared_context "ScreeningList::Fse data" do
  before(:all) do
    ...
    @all_possible_full_results ||= {}
    @all_possible_full_results[ScreeningList::Fse] = JSON.parse(
      open("#{File.dirname(__FILE__)}/screening_lists/fse/expected_results.json",).read,)
  end
end
...
shared_context "ScreeningList::El data" do
  before(:all) do
    ...
    @all_possible_full_results ||= {}
    @all_possible_full_results[ScreeningList::El] = JSON.parse(
      open("#{File.dirname(__FILE__)}/screening_lists/el/expected_results.json",).read,)
  end
end
...
shared_context "ScreeningList::Meu data" do
  before(:all) do
    ...
    @all_possible_full_results ||= {}
    @all_possible_full_results[ScreeningList::Meu] = JSON.parse(
      open("#{File.dirname(__FILE__)}/screening_lists/meu/expected_results.json",).read,)
  end
end
...
shared_context "ScreeningList::Dpl data" do
  before(:all) do
    ...
    @all_possible_full_results ||= {}
    @all_possible_full_results[ScreeningList::Dpl] = JSON.parse(
      open("#{File.dirname(__FILE__)}/screening_lists/dpl/expected_results.json",).read,)
  end
end
...
shared_context "ScreeningList::Uvl data" do
  before(:all) do
    ...
    @all_possible_full_results ||= {}
    @all_possible_full_results[ScreeningList::Uvl] = JSON.parse(
      open("#{File.dirname(__FILE__)}/screening_lists/uvl/expected_results.json",).read,)
  end
end
...
shared_context "ScreeningList::Isn data" do
  before(:all) do
    ...
    @all_possible_full_results ||= {}
    @all_possible_full_results[ScreeningList::Isn] = JSON.parse(
      open("#{File.dirname(__FILE__)}/screening_lists/isn/expected_results.json",).read,)
  end
end
...
shared_context "ScreeningList::Dtc data" do
  before(:all) do
    ...
    @all_possible_full_results ||= {}
    @all_possible_full_results[ScreeningList::Dtc] = JSON.parse(
      open("#{File.dirname(__FILE__)}/screening_lists/dtc/expected_results.json",).read,)
  end
end
...
shared_context "ScreeningList::Plc data" do
  before(:all) do
    ...
    @all_possible_full_results ||= {}
    @all_possible_full_results[ScreeningList::Plc] = JSON.parse(
      open("#{File.dirname(__FILE__)}/screening_lists/plc/expected_results.json",).read,)
  end
end
...
shared_context "ScreeningList::Ssi data" do
  before(:all) do
    ...
    @all_possible_full_results ||= {}
    @all_possible_full_results[ScreeningList::Ssi] = JSON.parse(
      open("#{File.dirname(__FILE__)}/screening_lists/ssi/expected_results.json",).read,)
  end
end
